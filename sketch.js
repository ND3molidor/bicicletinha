...
ciclistaPrincipal.addAnimation("running",img1CiclistaPrincipal);
ciclistaPrincipal.scale=0.07;
//ciclistaPrincipal.debug = true;
ciclistaPrincipal.setCollider("circle",0,10,550);
...
function draw() {
  ...
  textSize(20);
  text("aperte W para recomeçar o jogo",500,196);

  
  
    caminho.velocityX = 0;
    imgCaminho.velocityY = 0;
    ciclistaPrincipal.addAnimation("running",img2CiclistaPrincipal);
